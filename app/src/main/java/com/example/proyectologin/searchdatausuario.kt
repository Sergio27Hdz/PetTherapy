...
class searchdatausuario : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.fragment_search_activity__user)
        ...
        val eventListener: ValueEventListener = object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                if (snapshot.exists()) {
                    ...
                    val adapter = CustomAdapterUser(userInfos, this@searchdatausuario)
    ...
    class CustomAdapterUser(
    ...
    ) : RecyclerView.Adapter<com.example.proyectologin.CustomAdapterUser.ViewHolder>() {
        /**
        ...
        override fun onCreateViewHolder(
            viewGroup: ViewGroup,
            viewType: Int
        ): com.example.proyectologin.CustomAdapterUser.ViewHolder {
            val layoutInflater = LayoutInflater.from(viewGroup.context)
            val view = layoutInflater.inflate(R.layout.row_style_user, viewGroup, false)
            return com.example.proyectologin.CustomAdapterUser.ViewHolder(view)
        }

        // Replace the contents of a view (invoked by the layout manager)
        @RequiresApi(api = Build.VERSION_CODES.M)
        override fun onBindViewHolder(
            viewHolder: com.example.proyectologin.CustomAdapterUser.ViewHolder,
            position: Int
        ) {
            ...
            viewHolder.itemView.setOnClickListener {
                val intent = Intent(mcontext, details_user::class.java)
    ...
    fun BotonBuscar(view: View) {
        startActivity(Intent(this, searchdatausuario::class.java))
    }
    fun BotonChat(view: View) {
        startActivity(Intent(this, ListOfChatsActivity_User::class.java))
    }
