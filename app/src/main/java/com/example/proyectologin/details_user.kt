...
import kotlinx.android.synthetic.main.fragment_search_profile_user.*

class details_user : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.fragment_search_profile_user)
                    ...
                    for (ds in snapshot.children) {
                        ...
                        profileRef.getBytes(ONE_MEGABYTE).addOnSuccessListener {
                            ...
                            if(bitmap==null){
                                ...
                                profilePic3.setImageBitmap(bitmap)
                            }
                        }
                    }
                }
